...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("7363608399:AAGQyedrWAwg4-FefYak6RTG0fbeFSTGA10", "")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002169092630"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to join my Channel to use\n\nKindly join Channel</b>")
